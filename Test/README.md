...
### Introduction
This repository is a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**
...
`` git clone https://github.com/CliffordKasera/simple_shell ``
...
LOGNAME=Anon
TERM=xterm-256color
PATH=/home/Anon/bin:/home/Anon/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin
DISPLAY=:0
$ exit
Username@your-regular-prompt:~$ 
...
## Authors
* [CliffordKasera](https://github.com/CliffordKasera)
* [DagiiM](https://github.com/DagiiM)
